...
const DEFAULT_TOOLS = [
  ...
  { name: 'get_task', description: 'Get details of a specific task by ID', parameters: '{"type":"object","properties":{"id":{"type":"number","minimum":1}},"required":["id"]}' },
  ...
  { name: 'write_excel', description: 'Write data to an Excel (.xlsx) file. Creates new file if it does not exist. Supports cells, rows, columns, formulas, merge, and styling.', parameters: '{"type":"object","properties":{"path":{"type":"string","description":"File path to .xlsx file"},"operations":{"type":"array","items":{"type":"object","properties":{"type":{"type":"string","enum":["write_cell","write_row","write_column","formula","merge","style","column_width"]},"sheet":{"type":"string","description":"Sheet name"},"cell":{"type":"string","description":"Cell reference like A1"},"value":{},"values":{"type":"array"},"formula":{"type":"string","description":"Excel formula"},"range":{"type":"string","description":"Cell range"},"column":{"type":"string","description":"Column letter"},"width":{"type":"number","description":"Column width"},"style":{"type":"object","properties":{"bold":{"type":"boolean"},"italic":{"type":"boolean"},"fontSize":{"type":"number"},"fontColor":{"type":"string"},"fillColor":{"type":"string"},"numberFormat":{"type":"string"},"border":{"type":"boolean"}}}}}},"description":"Array of write operations"}},"required":["path","operations"]}' },
