...
const DEFAULT_TOOLS = [
  ...
  { name: 'email_list', description: 'List emails from inbox. Supports pagination and folder selection.', parameters: '{"type":"object","properties":{"folder":{"type":"string","description":"Folder name (default: INBOX)"},"limit":{"type":"number","description":"Max results (default: 20)"},"offset":{"type":"number","description":"Offset for pagination (default: 0)"}}}' },
  { name: 'email_read', description: 'Read full content of a specific email by ID.', parameters: '{"type":"object","properties":{"id":{"type":"string","description":"Email ID to read"}},"required":["id"]}' },
  { name: 'email_send', description: 'Send an email. Supports To, CC, BCC, and body text.', parameters: '{"type":"object","properties":{"to":{"type":"array","items":{"type":"string"},"description":"Recipients"},"subject":{"type":"string","description":"Email subject"},"body":{"type":"string","description":"Email body text"},"cc":{"type":"array","items":{"type":"string"},"description":"CC recipients"},"bcc":{"type":"array","items":{"type":"string"},"description":"BCC recipients"}},"required":["to","subject","body"]}' },
  { name: 'email_search', description: 'Search emails by keyword, sender, or date range.', parameters: '{"type":"object","properties":{"query":{"type":"string","description":"Search query"},"folder":{"type":"string","description":"Folder to search (default: all)"}},"required":["query"]}' },
  { name: 'email_reply', description: 'Reply to or forward an existing email.', parameters: '{"type":"object","properties":{"id":{"type":"string","description":"Email ID to reply to"},"body":{"type":"string","description":"Reply body text"},"mode":{"type":"string","enum":["reply","reply_all","forward"],"description":"Reply mode (default: reply)"}},"required":["id","body"]}' },
  { name: 'calendar_list_events', description: 'List calendar events within a date range.', parameters: '{"type":"object","properties":{"since":{"type":"string","description":"Start date ISO string"},"until":{"type":"string","description":"End date ISO string"}}}' },
  { name: 'calendar_create_event', description: 'Create a new calendar event with attendees.', parameters: '{"type":"object","properties":{"title":{"type":"string","description":"Event title"},"startTime":{"type":"string","description":"Start time ISO string"},"endTime":{"type":"string","description":"End time ISO string"},"description":{"type":"string","description":"Event description"},"attendees":{"type":"array","items":{"type":"string"},"description":"Attendee emails"},"location":{"type":"string","description":"Event location"}},"required":["title","startTime","endTime"]}' },
  { name: 'calendar_update_event', description: 'Update or delete a calendar event.', parameters: '{"type":"object","properties":{"id":{"type":"string","description":"Event ID"},"title":{"type":"string","description":"New title"},"startTime":{"type":"string","description":"New start time"},"endTime":{"type":"string","description":"New end time"},"action":{"type":"string","enum":["update","delete"],"description":"Action: update or delete (default: update)"}},"required":["id"]}' },
  { name: 'calendar_check_availability', description: 'Check if a time slot is available in the calendar.', parameters: '{"type":"object","properties":{"startTime":{"type":"string","description":"Start time ISO string"},"endTime":{"type":"string","description":"End time ISO string"}},"required":["startTime","endTime"]}' },
];
