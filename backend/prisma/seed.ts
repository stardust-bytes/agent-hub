...
const DEFAULT_TOOLS = [
  ...
  { name: 'google_drive_upload', description: 'Upload a file to Google Drive. Supports any file type via base64 content.', parameters: '{"type":"object","properties":{"name":{"type":"string","description":"File name with extension"},"contentBase64":{"type":"string","description":"File content as base64"},"mimeType":{"type":"string","description":"MIME type (default: text/plain)"}},"required":["name","contentBase64"]}', enabled: false },
