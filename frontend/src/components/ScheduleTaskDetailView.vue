<template>
  <div class="flex flex-col bg-cyber-bg min-w-0 h-full">
    <div class="flex items-center gap-2 xl:pl-3 pl-10 px-3 h-[3rem] border-b border-cyber-code-border shrink-0 bg-cyber-dark">
      <button @click="router.push('/tasks')" class="text-xs text-cyber-muted font-mono hover:text-cyber-accent transition-colors duration-150">&larr; {{ t('schedules.detail.back') }}</button>
