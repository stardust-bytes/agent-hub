<template>
  <div class="flex-1 flex flex-col bg-cyber-bg overflow-hidden">
    ...
    <div class="xl:pl-3 px-3 py-1.5 bg-cyber-dark/40 flex items-center gap-2 shrink-0">
    ...
    <div class="flex-1 overflow-y-auto">
      ...
      <div v-for="mem in filteredMemories" :key="mem.id"
        class="border-b border-cyber-code-border xl:pl-3 px-3 py-2 hover:bg-cyber-dark/40 transition-colors duration-150">
